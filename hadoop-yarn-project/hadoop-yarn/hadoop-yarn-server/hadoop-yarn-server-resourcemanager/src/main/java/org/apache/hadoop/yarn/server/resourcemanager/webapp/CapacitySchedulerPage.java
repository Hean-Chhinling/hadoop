  ...
  protected void postHead(Page.HTML<__> html) {
    html.
            ...
            __("document.addEventListener('DOMContentLoaded', function() {",
                    ...
                    "       const queue = { name: '', usedQueue: '', absCapacity: null, backgroundColor: null, dashedWidth: null, fullWidth: null, subQueues: [] };",
                    "",
                    ...
                    "        if (aElement){",
                    "            queue.absCapacity = aElement.title;",
                    ...
                    "            absCapacity: queueData?.absCapacity,",
                    ...
                    "",
                    "             node._rowElem.title = node.data.absCapacity;",
                    ...
                    "",
                    "             node._rowElem.style.setProperty('--dash-width', node.data.dashedWidth);",
