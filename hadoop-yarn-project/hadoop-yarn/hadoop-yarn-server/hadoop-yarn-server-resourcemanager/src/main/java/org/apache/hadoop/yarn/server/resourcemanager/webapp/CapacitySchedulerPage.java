  ...
  protected void postHead(Page.HTML<__> html) {
    html.
            ...
            __("#cs-tree { padding: 5px; font-family: Arial, sans-serif; font-size: 14px; }",
                    ...
                    /* Hide the Header and the file icon at the active user info*/
                    ".wb-header, .wb-icon.bi-file-earmark, div.wb-row.wb-expanded.user-table-row>span.wb-node.wb-col>i.wb-icon.bi.bi-folder2-open { display: none !important; }",
                    ...
                    "div.wb-row.user-header-info { font-weight: bold; background-color: #d3d3d3 !important; border: 1px solid #e6e6e6 !important; }",
            ...
            __("document.addEventListener('DOMContentLoaded', function() {",
                    ...
                    "             treeData.children.push({",
                    "                 title: '',",
                    "                 classes: 'space-row' // For space between the table data and active users info",
                    "             });",
                    "             treeData.children.push({",
                    "                 title: 'Active Users Info',",
                    "                 classes: 'active-header-info'",
                    "             });",
                    "",
                    "             treeData.children.push({",
                    "                 title: 'User Name',",
