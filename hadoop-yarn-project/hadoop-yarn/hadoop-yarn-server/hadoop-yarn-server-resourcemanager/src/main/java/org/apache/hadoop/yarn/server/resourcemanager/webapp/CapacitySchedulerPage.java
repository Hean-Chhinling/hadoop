...
class CapacitySchedulerPage extends RmView {
  ...
  protected void postHead(Page.HTML<__> html) {
    html.
            style().$type("text/css").
            __(
                    "#cs-tree { width: 2500px; height: 500px; border: 1px solid #ccc; padding: 5px; font-family: Arial, sans-serif; font-size: 14px; }",
            ...
            __("document.addEventListener('DOMContentLoaded', function() {",
                    ...
                    "       const queue = { name: '', usedQueue: '', subQueues: [] };",
                    "",
                    ...
                    "           userTable.querySelectorAll('td').forEach((td, i) => {",
                    ...
                    "         });",
                    "",
                    "         if (node.hasClass('queue-header') && node.data.usedQueue){ // For the Used Queue Percentage Highlight",
