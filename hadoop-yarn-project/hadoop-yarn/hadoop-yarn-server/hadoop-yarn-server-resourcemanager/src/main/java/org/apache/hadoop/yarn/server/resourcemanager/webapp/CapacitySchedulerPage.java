...
//                    "#cs { width: 1500px; border: 1px solid #ccc; padding: 5px; font-family: Arial, sans-serif; font-size: 14px; }",
            ...
            __("document.addEventListener('DOMContentLoaded', function() {",
                    ...
                    "   const tableRow3 = { title: 'Configured Weight', value: '36.0', classes: 'queue-table-row' };",
                    "   const tableRow4 = { title: 'Configured Max Capacity', value: 'unlimited', classes: 'queue-table-row' };",
                    "   const tableRow5 = { title: 'Effective Capacity', value: '<memory:310, vCores:0> (0.0%)', classes: 'queue-table-row' };",
                    "   const tableRow6 = { title: 'Effective Max Capacity', value: '<memory:1638, vCores:0> (2.5%)', classes: 'queue-table-row' };",
                    "   const tableRow7 = { title: 'Absolute Used Capacity', value: '0.0%', classes: 'queue-table-row' };",
                    "   const tableRow8 = { title: 'Absolute Configured Capacity', value: '0.5%', classes: 'queue-table-row' };",
                    "   const tableRow9 = { title: 'Absolute Configured Max Capacity', value: '2.5%', classes: 'queue-table-row' };",
                    "   const tableRow10 = { title: 'Used Resources', value: '<memory:0, vCores:0>', classes: 'queue-table-row' };",
                    "",
                    "   const createActiveUsersInfo = () => ({",
                    "     title: 'Active User Info',",
                    "     children: [",
                    "      {",
                    "        title: 'Username',",
                    "        data: {",
                    "           value: 'Max Resource', // Trick to display in all columns, using 'value' column instead",
                    "           weight: 'Weight',",
                    ...
                    "         },",
                    "        classes: 'user-header-info' // we could add a class to control that specific elements",
                    "      },",
                    "     {",
                    "        title: 'john_doe',",
                    "        data: {",
                    "           value: '<memory:2048, vCores:4>', // Trick to display in all columns, using 'value' column instead",
                    "           weight: '25.0',",
                    "           usedResource: '78.7%',",
                    "           maxAMResource: '10GB',",
                    "           usedAMResource: '7.43GB',",
                    "           schedulableApps: '5',",
                    "           nonSchedulableApps: '2',",
                    "        },",
                    ...
                    "     {",
                    "       title: 'Queue 1',",
                    "       children: [tableRow0, tableRow1, tableRow2, tableRow3, tableRow4, tableRow5, tableRow6, tableRow7, tableRow8, tableRow9, tableRow10, createActiveUsersInfo()],",
                    ...
                    "           }",
                    "           if ( col.id === 'value') {",
                    "               col.elem.textContent = node.data.value || '';",
                    "           }",
                    "      }",
                    "    }",
                    "   });",
